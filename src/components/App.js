...
function App() {
  ...
  function handleGameOver(finalScore) {
    // alert("Game Over Man!")
    navigate("/GameOver", { state: { finalScore: finalScore } });
  }
  ...
  // https://www.epidemicsound.com/track/gNJRRCyuzq/
  ...
  return (
    <Routes>
      ...
      <Route
        path="/GameOver"
        element={<GameOver handleNewScoreArray={handleNewScoreArray} />}
      />
      <Route
        path="/EndScreen"
        element={
          <EndScreen
            scores={scores}
            handleNewScoreArray={handleNewScoreArray}
          />
        }
      />
    </Routes>
